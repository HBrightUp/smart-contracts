...
namespace uosiosystem {
   ...
   class [[uosio::contract("uosio.system")]] native : public uosio::contract {
      public:
         ...
         using newaccount_action = uosio::action_wrapper<"newaccount"_n, &native::newaccount>;
         using updateauth_action = uosio::action_wrapper<"updateauth"_n, &native::updateauth>;
         using deleteauth_action = uosio::action_wrapper<"deleteauth"_n, &native::deleteauth>;
         using linkauth_action = uosio::action_wrapper<"linkauth"_n, &native::linkauth>;
         using unlinkauth_action = uosio::action_wrapper<"unlinkauth"_n, &native::unlinkauth>;
         using canceldelay_action = uosio::action_wrapper<"canceldelay"_n, &native::canceldelay>;
         using setcode_action = uosio::action_wrapper<"setcode"_n, &native::setcode>;
         using setabi_action = uosio::action_wrapper<"setabi"_n, &native::setabi>;
   };
}
