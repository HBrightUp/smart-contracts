const char* const uosio_system_abi = R"=====(
{
   ...
   "structs": [{
	...
	{"name":"quantity", "type":"asset"},
      ...
      "name": "one_minute_bp_list",
      "base": "",
      "fields": [
        {"name":"ulord_addr",                "type":"string"},
        {"name":"bp_valid_time",               "type":"uint64"},
      ...
      "fields": [
        ...
        {"name":"virtule_net_limit",   "type":"uint64"},
        {"name":"act_account",   "type":"account_name"},
        {"name":"act_name",   "type":"action_name"}
      ]
    },{
      "name": "setpriv",
      "base": "",
   ...
   "tables": [{
      ...
      "name": "uosclist",
      "type": "one_minute_bp_list",
      "index_type": "i64",
      "key_names" : ["bp_valid_time"],
      "key_types" : ["uint64"]
    },{
      "name": "voters",
      "type": "voter_info",
