...
namespace uosiosystem {
   ...
   struct [[uosio::table, uosio::contract("uosio.system")]] producer_info {
      ...
      // explicit serialization macro is not necessary, used here only to improve compilation time
      UOSLIB_SERIALIZE( producer_info, (owner)(total_votes)(producer_key)(is_active)(url)
   ...
   struct [[uosio::table, uosio::contract("uosio.system")]] voter_info {
      ...
      // explicit serialization macro is not necessary, used here only to improve compilation time
      UOSLIB_SERIALIZE( voter_info, (owner)(proxy)(producers)(staked)(last_vote_weight)(proxied_vote_weight)(is_proxy)(flags1)(reserved2)(reserved3) )
   };
   ...
   class [[uosio::contract("uosio.system")]] system_contract : public native {
      ...
      private:
         ...
         static symbol get_core_symbol( const rammarket& rm ) {
            ...
            uosio_assert(itr != rm.end(), "system contract must first be initialized");
