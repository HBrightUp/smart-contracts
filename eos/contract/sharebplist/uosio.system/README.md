...
## uosio.system::cfgproducer    account config
...
## uosio.system::okproducer     account producer vote
...
## uosio.system::setproxy       account proxy
...
## uosio.system::unstake        account quantity 
...
## uosio.system::withdraw account
   - this action can only be triggered by uosio.system via a deferred transaction generated by unstake
   - this will generate an inline uosio.token::transfer call from=uosio.system to=account and amount equal to the next withdraw increment
   - this will generate another deferred withdraw to continue the process if there are still withdraws to be made


## uosio.system::transfer from to amount memo
   - decrements balance of from if amount <= balance
   - increments balance of to by amount
   - memo is ignored 

## uosio.system::stakevote account amount
   - the primary currency of uosio is controlled by the token contract which enables users to transfer
...
## uosio.system::onblock   account blocktime blocknum
...
## uosio.system::freeze producer accounts true|false 
...
## uosio.system::paystandby producer
