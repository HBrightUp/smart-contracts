...
#include <uosiolib/types.hpp>
#include <uosiolib/print.hpp>
#include <uosiolib/privileged.h>
#include <uosiolib/optional.hpp>
...
namespace uosiosystem {
   ...
   struct authority {
      ...
      // explicit serialization macro is not necessary, used here only to improve compilation time
      UOSLIB_SERIALIZE( authority, (threshold)(delay_sec)(keys)(accounts) )
   };
   ...
   struct block_header {
      ...
      uosio::optional<uosio::producer_schedule> new_producers;
    ...
    */
   class native : public uosio::contract {
      public:
