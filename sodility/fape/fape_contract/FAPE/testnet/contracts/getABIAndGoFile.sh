...
solcjs --abi --include-path ../node_modules/ --base-path .  ./token/tokenFAPE.sol  -o ./abi
abigen --abi ./abi/token_tokenFAPE_sol_TokenFAPE.abi --pkg tokenFAPE --out ./goFile/tokenFAPE.go
