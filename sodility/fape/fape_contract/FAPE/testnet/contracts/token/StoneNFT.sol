...
contract StoneNFT is ERC721URIStorage, Ownable, ReentrancyGuard {
    ...
    address constant  public tokenFAPE = 0x7E331c577C1304B5e5b8BDf7d9cd91EEB87d8403;

    address constant  public blackHole = 0x000000000000000000000000000000000000dEaD;

    address constant public goverment = 0xFd91333656970c07D43B7967c3b0c34a7FBE6603;
    ...
    uint256 public generateFee = 100e18;
    ...
    function mintNFT(address account_, uint256 cardNo_) public onlyDapp nonReentrant returns (uint256)  {
        ...
        if(superior_ != address(0)) {
            ...
            SafeERC20.safeTransferFrom(IERC20(tokenFAPE), Commonlib.gameRewardsFunds, superior_, amount_);
        }
