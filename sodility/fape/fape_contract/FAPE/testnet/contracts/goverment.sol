...
contract Goverment is IGoverment, Initializable, ReentrancyGuardUpgradeable, OwnableUpgradeable {
    ...
    address constant tokenUSDT = 0x5C2346C83d156B74a4366E3F8192ed609EA90f51;
    ...
    function initialize() public initializer {
        ...
        tokenFAPE = 0x4310f0C19EFE23F689a69110Cd27a796222ed775;
        ticketNFT = 0xF6f8eCCD5E9D4aAF491DcE40D212DCd904f9CAF2;
        dapp = 0x1602eBb54fF8c513006085B9Ce2d6C21EBccc7CE;
        ...
        goldRankingTotalItems = 10;
        goldRankingTimesnap = 60;
        goldRankingLatestAwardTimestamp = block.timestamp;

        inviteRankingTotalItems = 3;
        inviteRankingTimesnap = 60;
    ...
    function buyVip(address account_, address superior_) external override onlyDapp nonReentrant returns (uint256) {
        ...
        //uint256 contribue_ = admissionTicket.div(1e18);
