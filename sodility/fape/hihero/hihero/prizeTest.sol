...
contract Prize is Initializable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    address public constant serviceAddr = 0xA74978BBD078064a516C0293047b562E187810f0;

    //asset of invest
    uint256 public constant minValue = 10e6;
    uint256 public constant maxValue = 9999e6;
    ...
    function initialize() public initializer {
        ...
        dapp = 0x24e88289CC3de84d52571e25B0610CD798DA5B04;
        tokenUSDT = 0x35ff193ef49201cDCCF1424AD7121c8cc49E3444;
    }
    ...
    function setDebugVictorNo(uint256 victor_) external onlyOwner {
        debug_victorNo = victor_;
    }
    ...
    function notifyReward(string memory nonce) external onlyDapp whenNotPaused nonReentrant  returns (bool) {
        ...
        if(debug_victorNo != 100) {
            victorNo_ = debug_victorNo;
        }
